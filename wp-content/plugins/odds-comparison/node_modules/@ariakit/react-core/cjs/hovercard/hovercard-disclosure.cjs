...
var _YMZPP75Icjs = require('../__chunks/YMZPP75I.cjs');
...
var _QR3ATHWUcjs = require('../__chunks/QR3ATHWU.cjs');
...
var useHovercardDisclosure = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    ...
    const { style } = _QR3ATHWUcjs.useVisuallyHidden.call(void 0, );
    if (!visible) {
    ...
    props = _YMZPP75Icjs.useDialogDisclosure.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var HovercardDisclosure = _CWY2PHPRcjs.createComponent.call(void 0, 
  (props) => {
