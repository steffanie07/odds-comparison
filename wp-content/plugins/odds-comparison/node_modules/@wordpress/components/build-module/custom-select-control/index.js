...
const itemToString = item => item?.name; // This is needed so that in Windows, where
...
export default function CustomSelectControl(props) {
  ...
  }, selectedItem.__experimentalHint))), createElement("ul", { ...menuProps,
...
export function StableCustomSelectControl(props) {
  return createElement(CustomSelectControl, { ...props,
    __experimentalShowSelectedHint: false
  });
}
