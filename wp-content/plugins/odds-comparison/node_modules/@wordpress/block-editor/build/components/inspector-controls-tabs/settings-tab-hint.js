...
function InspectorControlsTabsHint() {
  const isInspectorControlsTabsHintVisible = (0, _data.useSelect)(select => {
    var _select$get;
  ...
  }, (0, _i18n.__)("Looking for other block settings? They've moved to the styles tab.")), (0, _element.createElement)(_components.Button, {
