...
var useMenuItem = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    ...
    const contentElement = _BEGWNNXKcjs.useStoreState.call(void 0, 
      store,
    ...
    props = _AU2JPBQEcjs.useCompositeItem.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store, preventScrollOnKeyDown }, props));
