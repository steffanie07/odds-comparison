...
function Edit({
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    fetch('/wp-json/odds/v1/bookmakers').then(response => response.json()).then(data => {
      setBookmakers(data);
    });
  }, []);
  const handleBookmakersChange = selected => {
    ...
    setAttributes({
      selectedBookmakers: JSON.stringify(selected)
    });
  };
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Odds Comparison Settings')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
    multiple: true,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Bookmakers'),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Odds Format'),
    ...
    if (bookmaker) {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("tr", {
        key: bookmakerId
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("td", null, bookmaker.bookmaker), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("td", null, displayOdd));
    }
    return null;
  }))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "No bookmakers selected") : 'Loading...');
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"odds-comparison/odds-comparison","version":"1.0.0","title":"Odds-comparison","category":"widgets","icon":"flag","description":"Displays odds comparisons","attributes":{"bookmaker":{"type":"string","default":"Bookmaker1"}},"supports":{"html":false},"textdomain":"odds-comparison","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkodds_comparison"] = self["webpackChunkodds_comparison"] || [];
