...
class URLInput extends _element.Component {
  ...
  renderControl() {
    ...
    return (0, _element.createElement)(_components.BaseControl, {
      ...
      ...controlProps
    }, (0, _element.createElement)("input", { ...inputProps
    }), loading && (0, _element.createElement)(_components.Spinner, null));
  }
  ...
  renderSuggestions() {
    ...
    return (0, _element.createElement)(_components.Popover, {
      placement: "bottom",
      focusOnMount: false
    }, (0, _element.createElement)("div", { ...suggestionsListProps,
      className: (0, _classnames.default)('block-editor-url-input__suggestions', `${className}__suggestions`)
    }, suggestions.map((suggestion, index) => (0, _element.createElement)(_components.Button, { ...buildSuggestionItemProps(suggestion, index),
      key: suggestion.id,
