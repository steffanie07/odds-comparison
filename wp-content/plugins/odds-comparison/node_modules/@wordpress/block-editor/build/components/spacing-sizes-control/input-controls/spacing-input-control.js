...
function SpacingInputControl({
  ...
  const ariaLabel = (0, _i18n.sprintf)( // translators: 1: The side of the block being modified (top, bottom, left, All sides etc.). 2. Type of spacing being modified (Padding, margin, etc)
  ...
  return (0, _element.createElement)(_components.__experimentalHStack, {
  ...
  }, icon && (0, _element.createElement)(_components.Icon, {
    ...
    onFocus: onMouseOver,
    onBlur: onMouseOut
  }), !disableCustomSpacingSizes && (0, _element.createElement)(_components.Button, {
