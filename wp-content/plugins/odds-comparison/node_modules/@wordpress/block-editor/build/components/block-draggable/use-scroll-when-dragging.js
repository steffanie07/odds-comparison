...
function useScrollWhenDragging() {
  const dragStartY = (0, _element.useRef)(null);
  const velocityY = (0, _element.useRef)(null);
  const scrollParentY = (0, _element.useRef)(null);
  const scrollEditorInterval = (0, _element.useRef)(null); // Clear interval when unmounting.
