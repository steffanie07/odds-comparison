...
var useCollectionItem = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
    ...
    const unrenderItem = _react.useRef.call(void 0, );
...
var CollectionItem = _CWY2PHPRcjs.createComponent.call(void 0, 
  (props) => {
