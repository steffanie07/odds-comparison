...
function ColorPanelTab({
  ...
  return (0, _element.createElement)(_control.default, { ...colorGradientControlSettings,
    showTitle: false,
    enableAlpha: true,
...
function ColorPanelDropdown({
  ...
  return (0, _element.createElement)(_components.__experimentalToolsPanelItem, {
    ...
    renderToggle: ({
      ...
      }, (0, _element.createElement)(LabeledColorIndicators, {
    ...
    renderContent: () => (0, _element.createElement)(_components.__experimentalDropdownContentWrapper, {
    ...
    }, tabs.length === 1 && (0, _element.createElement)(ColorPanelTab, { ...tabs[0],
      ...
      return (0, _element.createElement)(ColorPanelTab, { ...selectedTab,
        colorGradientControlSettings: colorGradientControlSettings
      });
    })))
  }));
...
function ColorPanel({
  ...
  return (0, _element.createElement)(Wrapper, {
    ...
    onChange: onChange,
    panelId: panelId
  }, items.map(item => (0, _element.createElement)(ColorPanelDropdown, {
    key: item.key,
    ...item,
    colorGradientControlSettings: {
      colors,
