...
export function BlockSettingsDropdown({
  ...
  const removeBlockLabel = count === 1 ? __('Delete') : __('Delete blocks'); // Allows highlighting the parent block outline when focusing or hovering
  ...
  }), !parentBlockIsSelected && !!firstParentClientId && createElement(MenuItem, { ...showParentOutlineGestures,
    ref: selectParentButtonRef,
