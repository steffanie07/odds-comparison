...
var useCompositeItem = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    ...
    const rowId = _BEGWNNXKcjs.useStoreState.call(void 0, store, (state) => {
      if (rowIdProp)
        return rowIdProp;
    ...
    const baseElement = _BEGWNNXKcjs.useStoreState.call(void 0, 
      store,
    ...
    const isActiveItem = _BEGWNNXKcjs.useStoreState.call(void 0, store, (state) => state.activeId === id);
    const virtualFocus = _BEGWNNXKcjs.useStoreState.call(void 0, store, "virtualFocus");
    ...
    const ariaSetSize = _BEGWNNXKcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const ariaPosInSet = _BEGWNNXKcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const isTabbable = (_a2 = _BEGWNNXKcjs.useStoreState.call(void 0, store, (state) => {
