...
function BlockQuickNavigation({
  ...
  return (0, _element.createElement)(_components.__experimentalVStack, {
    spacing: 1
  }, clientIds.map(clientId => (0, _element.createElement)(BlockQuickNavigationItem, {
    key: clientId,
    clientId: clientId
  })));
}
...
function BlockQuickNavigationItem({
  ...
  const {
    ...
    return {
      name: blockType && (0, _blocks.__experimentalGetBlockLabel)(blockType, attributes, 'list-view'),
      icon: blockType?.icon,
  ...
  return (0, _element.createElement)(_components.Button, {
    ...
    icon: icon
  }), (0, _element.createElement)(_components.FlexItem, null, name)));
}
