...
function getBlockCSSSelector(blockType, target = 'root', options = {}) {
  ...
  if (pathArray.length === 1) {
    ...
    if (hasSelectors) {
      ...
      const featureSelector = (0, _object.getValueFromObjectPath)(selectors, `${path}.root`, null) || (0, _object.getValueFromObjectPath)(selectors, path, null); // Return feature selector if found or any available fallback.

      return featureSelector || fallbackSelector;
    } // Try getting old experimental supports selector value.


    const featureSelector = (0, _object.getValueFromObjectPath)(supports, `${path}.__experimentalSelector`, null); // If nothing to work with, provide fallback selector if available.
  ...
  if (hasSelectors) {
    subfeatureSelector = (0, _object.getValueFromObjectPath)(selectors, path, null);
