...
import { getBlockType, getSaveContent, isUnmodifiedDefaultBlock, serializeRawBlock, switchToBlockType, getDefaultBlockName, isUnmodifiedBlock } from '@wordpress/blocks';
...
function BlockListBlock({
  ...
  if (!isValid) {
    ...
    block = createElement(Block, { ...wrapperProps
    }, blockEdit);
  }
