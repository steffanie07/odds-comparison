...
function ColorPanelTab({
  ...
  return createElement(ColorGradientControl, { ...colorGradientControlSettings,
    showTitle: false,
    enableAlpha: true,
...
function ColorPanelDropdown({
  ...
  return createElement(ToolsPanelItem, {
    ...
    renderContent: () => createElement(DropdownContentWrapper, {
    ...
    }, tabs.length === 1 && createElement(ColorPanelTab, { ...tabs[0],
      ...
      return createElement(ColorPanelTab, { ...selectedTab,
        colorGradientControlSettings: colorGradientControlSettings
      });
    })))
  }));
