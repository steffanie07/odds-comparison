...
function useInnerBlocksProps(props = {}, options = {}) {
  ...
  return { ...props,
    ref,
    children: (0, _element.createElement)(InnerBlocks, { ...options,
      clientId: clientId,
      wrapperRef: ref
    })
  };
...
const InnerBlocks = props => {
  ...
  return props.value && props.onChange ? (0, _element.createElement)(ControlledInnerBlocks, { ...allProps
  }) : (0, _element.createElement)(UncontrolledInnerBlocks, { ...allProps
  });
