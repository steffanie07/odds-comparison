...
function DropdownMenu({
  ...
  return (0, _element.createElement)(_dropdown.default, {
    ...
    renderToggle: ({
      ...
      return (0, _element.createElement)(_button.default, { ...mergedToggleProps,
        icon: icon,
        onClick: event => {
          onToggle(event);
    ...
    renderContent: ({
      ...
      }, controlSets?.flatMap((controlSet, indexOfSet) => controlSet.map((control, indexOfControl) => (0, _element.createElement)(_components.BottomSheet.Cell, {
