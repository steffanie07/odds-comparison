...
const TouchableRipple = ({
  ...
  if (isTouchableNativeSupported) {
    ...
    return (0, _element.createElement)(_reactNative.TouchableNativeFeedback, { ...touchableProps,
      onPress: onPress,
      disabled: disabled,
  ...
  return (0, _element.createElement)(_reactNative.TouchableOpacity, { ...touchableProps,
    onPress: onPress,
    disabled: disabled,
