...
var _IXZRUZTMcjs = require('../__chunks/IXZRUZTM.cjs');


var _BJRJETRDcjs = require('../__chunks/BJRJETRD.cjs');
require('../__chunks/AU2JPBQE.cjs');
...
var useToolbarContainer = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    ...
    props = _IXZRUZTMcjs.useCompositeContainer.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    props = _BJRJETRDcjs.useToolbarItem.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
