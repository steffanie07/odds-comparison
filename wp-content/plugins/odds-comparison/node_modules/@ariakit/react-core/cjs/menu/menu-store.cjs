...
var _LCJP3BHKcjs = require('../__chunks/LCJP3BHK.cjs');
require('../__chunks/X44H72BI.cjs');



var _5UCVOKTGcjs = require('../__chunks/5UCVOKTG.cjs');
require('../__chunks/3OCFY7CV.cjs');
require('../__chunks/AD4BY53T.cjs');
require('../__chunks/DGSPHMOA.cjs');




var _BEGWNNXKcjs = require('../__chunks/BEGWNNXK.cjs');
...
function useMenuStoreOptions(props) {
  ...
  const placement = _BEGWNNXKcjs.useStoreState.call(void 0, 
  ...
  return _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {}, _LCJP3BHKcjs.useCompositeStoreOptions.call(void 0, props)), _5UCVOKTGcjs.useHovercardStoreOptions.call(void 0, props)), {
...
function useMenuStoreProps(store, props) {
  const parentMenu = _react.useContext.call(void 0, _MPFAD3UKcjs.MenuContext);
  store = _LCJP3BHKcjs.useCompositeStoreProps.call(void 0, store, props);
  store = _5UCVOKTGcjs.useHovercardStoreProps.call(void 0, store, props);
  _BEGWNNXKcjs.useStoreProps.call(void 0, store, props, "values", "setValues");
...
function useMenuStore(props = {}) {
  ...
  const store = _BEGWNNXKcjs.useStore.call(void 0, () => Core.createMenuStore(_72I2GWXFcjs.__spreadValues.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {}, props), options)));
