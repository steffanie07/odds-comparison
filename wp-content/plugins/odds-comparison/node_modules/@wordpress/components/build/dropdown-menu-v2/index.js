...
const UnconnectedDropdownMenu = props => {
  const {
    ...
    variant
  } = (0, _context.useContextSystem)(props, 'DropdownMenu'); // Render the portal in the default slot used by the legacy Popover component.
...
const DropdownMenuItem = (0, _element.forwardRef)(({
  ...
  return (0, _element.createElement)(DropdownMenuStyled.Item, { ...props,
    ref: forwardedRef
...
const DropdownMenuCheckboxItem = ({
  ...
  return (0, _element.createElement)(DropdownMenuStyled.CheckboxItem, { ...props,
    checked: checked
...
const DropdownMenuRadioItem = ({
  ...
  return (0, _element.createElement)(DropdownMenuStyled.RadioItem, { ...props
...
const DropdownMenuSeparator = props => {
  ...
  return (0, _element.createElement)(DropdownMenuStyled.Separator, { ...props,
    variant: variant
  });
};
