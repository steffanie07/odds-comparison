...
function useTabNav() {
  ...
  const ref = (0, _compose.useRefEffect)(node => {
    function onKeyDown(event) {
      ...
      const nextTabbable = _dom.focus.tabbable[direction](event.target); // We want to constrain the tabbing to the block and its child blocks.
      ...
      const isElementPartOfSelectedBlock = currentBlock && nextTabbable && ((0, _dom2.isInSameBlock)(currentBlock, nextTabbable) || (0, _dom2.isInsideRootBlock)(currentBlock, nextTabbable)); // Allow tabbing from the block wrapper to a form element,
